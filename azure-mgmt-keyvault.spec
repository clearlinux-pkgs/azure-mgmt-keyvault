...
Source0  : https://files.pythonhosted.org/packages/69/56/678b158efbd4b4d70151a0d688e11a529a42eac3ff426813878f253f76c4/azure-mgmt-keyvault-8.0.0.zip
Summary  : Microsoft Azure MyService Management Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-keyvault-python = %{version}-%{release}
Requires: azure-mgmt-keyvault-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-keyvault package.
Group: Default
Requires: azure-mgmt-keyvault-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-keyvault package.


%package python3
Summary: python3 components for the azure-mgmt-keyvault package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_keyvault)
Requires: pypi(azure_common)
Requires: pypi(azure_mgmt_core)
Requires: pypi(msrest)

%description python3
python3 components for the azure-mgmt-keyvault package.


%prep
%setup -q -n azure-mgmt-keyvault-8.0.0
cd %{_builddir}/azure-mgmt-keyvault-8.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608046643
